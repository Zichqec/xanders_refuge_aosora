...
talk OnAskGods_Aion
{
	...
	\s[222]Aion is the god of fate. They're the ultimate authority on everything, even the gods. \s[213]Absolutely nothing escapes their grasp. 
...
talk OnAskGods_Dueyar
{
	...
	\s[220]Dueyar is the god of justice and order, and I suppose you could call her my sister. \s[221]It's a little more complicated than that, but I wouldn't expect a mortal to understand. 
...
{
	\s[11]That's me. \s[111]God of luck, if you've forgotten.\w8\w8{br}{XaeyarDescript}
}

talk OnAskGods_Iella
{
	\s[0]Iella is the god of jealousy and greed. She wants pretty much anything she can get her hands on. \s[130]Especially if someone else has it. \s[11]If you can believe it, this causes strife between her and the other gods quite frequently. 
...
talk OnAskGods_Enva
{
	\s[0]Enva is the god of strategy. \s[11]You'd think she'd get on well with the god of war, but not really. \s[220]She's the manipulative sort, always carefully pulling the strings to align things in her favor. \s[221]She's not really a fan of mine. 
...
{
	\s[200]Kasarae is the god of war and strength. \s[211]Might makes everything right, according to her. \s[130]I would suggest staying out of her way if you see her, \s[230]she's known for brutal murders whenever the mood strikes. 
...
{
	\s[0]Nyphine is the god of loyalty. \s[11]She believes in forming strong bonds, and pursuing them above all else. \s[113]Unfortunately that makes her very loyal to fate, as well. \s[222]As to be expected, I suppose. 
...
{
	\s[0]Tysus is the god of health. \s[11]And he will nag you about it relentlessly. 
...
{
	\s[0]Gabin is the god of love. \s[22]He's the soft sort that gets attached easily to just about anyone. \s[113]This inevitably leads to heartbreak whenever his favorite mortal of the century dies, as mortals tend to do. 
...
{
	\s[0]Meiyr is the god of understanding. \s[11]That's a lot scarier than it sounds. \s[130]They struggle with many inner demons, and they want their turmoil to be understood, you see. 
...
//br here made it not pause, so it gets a manual pause...
talk OnAskGods_Tohmjir
{
	\s[11]Tohmjir is the god of growth and decay. \s[111]I imagine that sounds scary to a mortal, but he's one of the least scary gods you could meet. \s[31]The man just wants to grow plants and watch over decomposing skulls,\w4{br}how can he be faulted for that? 
...
{
	\s[221]Nemara is the god of impulsivity, and is extremely hot-headed. \s[230]She'd punch you right in the face at the drop of a hat if her mood is sour, and it usually is. \s[0]We tend to end up on the same side of various issues, though. She doesn't care much for living life in the way it was laid out for her. 
...
{
	\s[0]Thaelia is the god of balance. \s[131]That's what she calls herself, anyways, but it's a bit of a misnomer. \s[30]Balance in a vestibular sense,\w4{br}not as in managing the forces of good and evil. \s[100]Although, it's actually a wider domain than even that; she covers all sorts of so-called 6th senses, and subconscious processes. 
...
{
	\s[111]Vismir is the god of invention. If you've ever found yourself suddenly struck with a seemingly brilliant idea, that's his influence. \s[31]Actual brilliance of the idea may vary. 
...
talk OnAskGods_Sajun
{
	...
	\s[111]Sajun is one half of the god of joy. \s[11]He and his "brother" @Malous used to be a singular being, \w4\s[200]but they were deemed too powerful and were split in two. \s[211]Together they could give and take joy at will, but alone, Sajun can only give joy. 
...
talk OnAskGods_Malous
{
	...
	\s[111]Malous is one half of the god of joy. \s[11]He and his "brother" @Sajun used to be a singular being, \w4\s[200]but they were deemed too powerful and were split in two. \s[211]Together they could give and take joy at will, but alone, Malous can only take joy. 
...
{
	\t\*\s[231]Did I not explain this to you already? \s[131]Xaeyar is my name, or your mortal approximation of it. \s[111]Xaeyar, god of luck? One of several deities that influences this world you inhabit? \w8\w8\w8
...
{
	\t\*\s[230]Who is Xaeyar? \s[231]Don't they teach you this in school? 
...
{
	\t\*\s[230]Who is {Shiori.Reference[0]}? \s[231]Don't they teach you this in school? 
...
{
	\s[0]Right... you wanted to know about me in particular. \s[222]How to explain... I don't usually have to tell people about myself. \w8\w8
	
	{smoke}\s[111]As I said previously, I am the god of luck. {XaeyarDescript}\x
}
...
{
	\s[0].\w8.\w8. \w8\w8\s[11]I might have caused a bit of trouble back home. \s[100]Maybe, say, stepped on{br}@Dueyar's toes a little too heavily. 
...
{
	\s[11]Well, as I mentioned, she's the god of justice and order. \s[211]A lot of emphasis on that justice part. 
	...
	\s[0]He was set to be executed for his numerous crimes, and rightly so. \x\0\n[-200]
	
	\s[0]Anyways, he broke free, thanks to a tiny favor from me. \s[111]I thought it would be more interesting if things didn't go perfectly to plan. 
	...
	\s[220]They caught him again not that long later;\w8{br}fate had already decided that it was his time, so I'm not sure what harm a little bump in the road really caused there. \s[221]If anything, I'm keeping them from becoming too complacent. \x\0\n[-200]
...
{
	\s[0]Well they're the greatest tyrant in the universe, for one. \s[211]Sure they mostly stay in the background, but they're pulling the strings on everything. \s[111]Their authority goes, and they don't really listen to anyone else. 
	
	\s[220]Not even the other gods, it's hardly fair to compare us to them. \s[221]We're all pawns in their little game. \s[121]And if that's the way things are going to be, I may as well make it at least somewhat challenging for them.\w8\w8\x\0\n[-200]
...
{
	{smoke(2)}\s[222]As I told you before, they're the two halves of what used to be the singular god of joy. \s[122]I've been around since the beginning of time, practically speaking, so I knew him. \s[211]And I was there the day he was torn in two. \x\0\n[-200]
	
	\s[200]Things have never been quite the same since then. \s[220]It's one of the few times I've ever seen @Aion take an active role, and the only time they have acted outwardly against one of us. 
	
	\s[221]I suppose he must have been causing some sort of problem with their ultimate plan for the world. Or perhaps they were simply dissatisfied with what they had made. \x\0\n[-200]
	...
	\s[222]I think, for a moment, I understood what it was to be mortal. To have no say in what was happening, and no chance to stop it. \s[22]To realize that my own life could be taken away at fate's whim. \s[13]That we are not, in fact, untouchable. \x\0\n[-200]
	...
	\s[213]There isn't really a way to escape fate, of that much I am certain. \s[11]But I \f[italic,1]can\f[italic,default] be a thorn in their side. \x\0\n[-200]
...
talk OnStory@Locked
{
	\s[21]That's hardly any business of yours, mortal.
}
